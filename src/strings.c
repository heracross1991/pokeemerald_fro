...
const u8 gText_BatteryRunDry[] = _("For intended experience please do \nnot use savestates or increase game \lspeed. \pThe developer(s) put a lot of time \nand effort into making this.");
...
const u8 gText_ThisIsAPokemon[] = _("This is the Pokémon I've\ndiscovered.{PAUSE 96}\p");
...
const u8 gMenuText_Relearn[] = _("RELEARN");
...
const u8 gText_NoMoveToRelearn[] = _("No moves to relearn!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_FlobraDollAndPrice[] = _("FLOBRA DOLL   1,000 COINS");
