...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_FLOBRA] = BACK_ANIM_H_SLIDE,
    [SPECIES_MORPHLO] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_MECHOBRA] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    ...
    [SPECIES_COOTINY] = BACK_ANIM_SHRINK_GROW_2,
};
