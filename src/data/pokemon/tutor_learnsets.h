...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_FLOBRA]        = TUTOR_LEARNSET(TUTOR(MOVE_BODY_SLAM)
											| TUTOR(MOVE_COUNTER)
											| TUTOR(MOVE_DEFENSE_CURL)
											| TUTOR(MOVE_DOUBLE_EDGE)
											| TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_MORPHLO]     = TUTOR_LEARNSET(TUTOR(MOVE_BODY_SLAM)
											| TUTOR(MOVE_COUNTER)
											| TUTOR(MOVE_DEFENSE_CURL)
											| TUTOR(MOVE_DOUBLE_EDGE)
											| TUTOR(MOVE_DYNAMIC_PUNCH)
    ...
    [SPECIES_MECHOBRA]      = TUTOR_LEARNSET(TUTOR(MOVE_BODY_SLAM)
											| TUTOR(MOVE_COUNTER)
											| TUTOR(MOVE_DEFENSE_CURL)
											| TUTOR(MOVE_DOUBLE_EDGE)
											| TUTOR(MOVE_DYNAMIC_PUNCH)
    ...
    [SPECIES_EMBORYPS]      = TUTOR_LEARNSET(TUTOR(MOVE_COUNTER)
											| TUTOR(MOVE_ENDURE)
											| TUTOR(MOVE_FIRE_PUNCH)
											| TUTOR(MOVE_MUD_SLAP)
											| TUTOR(MOVE_ROLLOUT)
    ...
    [SPECIES_RASCALOOT]         = TUTOR_LEARNSET(TUTOR(MOVE_SLEEP_TALK)
											| TUTOR(MOVE_SNORE)
											| TUTOR(MOVE_SUBSTITUTE)
											| TUTOR(MOVE_SWAGGER)
											| TUTOR(MOVE_SWORDS_DANCE)),
	...
	[SPECIES_COOTINY]     = TUTOR_LEARNSET(TUTOR(MOVE_BODY_SLAM)
											| TUTOR(MOVE_DEFENSE_CURL)
											| TUTOR(MOVE_DOUBLE_EDGE)
											| TUTOR(MOVE_ENDURE)
											| TUTOR(MOVE_FURY_CUTTER)
