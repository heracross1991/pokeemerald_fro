...
static const union AnimCmd *const sAnims_LibertyGruntM[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_John[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_LibertyDouble[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LIBERTY_GRUNT_M] = sAnims_LibertyGruntM,
	...
	[TRAINER_PIC_JOHN] = sAnims_John,
    [TRAINER_PIC_LIBERTY_DOUBLE] =sAnims_LibertyDouble
};
