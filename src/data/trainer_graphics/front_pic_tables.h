const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_LIBERTY_GRUNT_M] = {.size = 8, .y_offset = 1},
	...
	[TRAINER_PIC_JOHN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LIBERTY_DOUBLE] = {.size = 8, .y_offset = 1},
};

const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    TRAINER_SPRITE(HIKER, gTrainerFrontPic_Hiker, 0x800),
    TRAINER_SPRITE(LIBERTY_GRUNT_M, gTrainerFrontPic_LibertyGruntM, 0x800),
	...
	TRAINER_SPRITE(JOHN, gTrainerFrontPic_John, 0x800),
    TRAINER_SPRITE(LIBERTY_DOUBLE, gTrainerFrontPic_LibertyDouble, 0x800),
};

const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    TRAINER_PAL(HIKER, gTrainerPalette_Hiker),
    TRAINER_PAL(LIBERTY_GRUNT_M, gTrainerPalette_LibertyGruntM),
	...
	TRAINER_PAL(JOHN, gTrainerPalette_John),
    TRAINER_PAL(LIBERTY_DOUBLE, gTrainerPalette_LibertyDouble),
};
