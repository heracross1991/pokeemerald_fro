...
const u32 gObjectEventPic_Boy2[] = INCBIN_U32("graphics/object_events/pics/newpeople/john.4bpp");
...
const u16 gEventObjectPalette_john[] = INCBIN_U16("graphics/object_events/palettes/john.gbapal");