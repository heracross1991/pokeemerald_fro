static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LAKE_MEAD_VILLAGE - 1] = {MAP_GROUP(LAKE_MEAD_VILLAGE), MAP_NUM(LAKE_MEAD_VILLAGE), 11, 10},
    [HEAL_LOCATION_WALMORE_TOWN - 1] = {MAP_GROUP(WALMORE_TOWN), MAP_NUM(WALMORE_TOWN), 17, 8},
};
