...
const u32 gTrainerFrontPic_LibertyGruntM[] = INCBIN_U32("graphics/trainers/front_pics/hiker_front_pic.4bpp.lz");
const u32 gTrainerPalette_LibertyGruntM[] = INCBIN_U32("graphics/trainers/palettes/cool_trainer_m.gbapal.lz");
